...
activities = {
    ...
    "Soccer Team": {
        "description": "Team drills and matches to build soccer skills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Practice strokes, endurance, and prepares for swim meets",
    ...
    "Math Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["john@mergington.edu", "emma@mergington.edu"]
    }
}
